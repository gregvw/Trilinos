...
template<class Real>
void rec_jacobi( std::shared_ptr<Teuchos::LAPACK<int,Real> > lapack,
                 const double alpha, 
                 const double beta,
                 std::vector<Real> &a,
                 std::vector<Real> &b ) {
...
template<class Real>
void gauss( std::shared_ptr<Teuchos::LAPACK<int,Real> > lapack,
...
template<class Real>
void rec_lobatto( std::shared_ptr<Teuchos::LAPACK<int,Real> > const lapack,
                  const double xl1, 
                  const double xl2,
                  std::vector<Real> &a,
                  std::vector<Real> &b ) {
