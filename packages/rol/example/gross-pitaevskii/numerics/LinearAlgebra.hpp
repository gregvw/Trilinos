...
template<class Real>
void trisolve(std::shared_ptr<Teuchos::LAPACK<int,Real> > lapack,
 ...
 */
template<class Real>
void lusolve(std::shared_ptr<Teuchos::LAPACK<int,Real> > lapack,
             const std::vector<Real> &A,
             const std::vector<Real> &B,
                   std::vector<Real> &X) {
 ...
 */
template<class Real>
void cholsolve(std::shared_ptr<Teuchos::LAPACK<int,Real> > lapack,
               const std::vector<Real> &A,
               const std::vector<Real> &B,
                     std::vector<Real> &X) {
