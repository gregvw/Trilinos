    ...
    */
    ...
    void solve_circuit(ROL::Vector<Real> &I, const ROL::Vector<Real> &S){
      ROL::SharedPointer<std::vector<Real> > Ip =
        ROL::constPointerCast<std::vector<Real> >((dynamic_cast<ROL::StdVector<Real>&>(I)).getVector());
...
public:
  ...
  void pruneLowerActive(ROL::Vector<Real> &v, const ROL::Vector<Real> &x, Real eps) {
    ...
    ROL::SharedPointer<std::vector<Real> > ev =
      ROL::constPointerCast<std::vector<Real> >((dynamic_cast<ROL::StdVector<Real>&>(v)).getVector());
...
//       ROL::SharedPointer<std::vector<Real> > S_rcp = ROL::makeShared<std::vector<Real>>(2,0.0);
