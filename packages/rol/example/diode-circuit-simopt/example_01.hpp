...
private:
  ...
  std::shared_ptr<std::vector<Real> > Vsrc_; 
  ...
  /*!
    ...
    */
    ...
    void solve_circuit(ROL::Vector<Real> &I, const ROL::Vector<Real> &S){
      std::shared_ptr<std::vector<Real> > Ip =
        std::const_pointer_cast<std::vector<Real> >((dynamic_cast<ROL::StdVector<Real>&>(I)).getVector());
      std::shared_ptr<const std::vector<Real> > Sp =
        (dynamic_cast<ROL::StdVector<Real> >(const_cast<ROL::Vector<Real> &&>(S))).getVector();
...
public:
  ...
  Constraint_DiodeCircuit(Real Vth, Real Vsrc_min, Real Vsrc_max, Real Vsrc_step){
    ...
    Vsrc_ = std::make_shared<std::vector<Real>>(ns_,0.0);
    for(int i=0;i<ns_;i++){
  ...
  void applyAdjointHessian_11(ROL::Vector<Real> &ahwv, const ROL::Vector<Real> &w, const ROL::Vector<Real> &v,const ROL::Vector<Real> &u, const ROL::Vector<Real> &z, Real &tol) {
    std::shared_ptr<std::vector<Real> > ahwvp =
      std::const_pointer_cast<std::vector<Real> >((dynamic_cast<ROL::StdVector<Real>&>(ahwv)).getVector());
...
private:
  ...
  int ns_,nz_;
  std::shared_ptr<std::vector<Real> > Imeas_;
...
public: 
  ...
  Objective_DiodeCircuit(Real alpha, int ns, int nz){
    ...
    nz_ = nz;
    alpha_ = alpha;
    Imeas_ = std::make_shared<std::vector<Real>>(ns_,0.0);
    Real temp;
  ...
  void gradient_1( ROL::Vector<Real> &g, const ROL::Vector<Real> &u, const ROL::Vector<Real> &z, Real &tol ) {
    // Unwrap g
    std::shared_ptr<std::vector<Real> > gup = std::const_pointer_cast<std::vector<Real> >(
  ...
  void gradient_2( ROL::Vector<Real> &g, const ROL::Vector<Real> &u, const ROL::Vector<Real> &z, Real &tol ) {
    // Unwrap g
    std::shared_ptr<std::vector<Real> > gzp = std::const_pointer_cast<std::vector<Real> >(
      (dynamic_cast<const ROL::StdVector<Real>&>(g)).getVector());
    // Unwrap x
    std::shared_ptr<const std::vector<Real> > up =
      (dynamic_cast<ROL::StdVector<Real> >(const_cast<ROL::Vector<Real> &&>(u))).getVector();
  ...
  void hessVec_11( ROL::Vector<Real> &hv, const ROL::Vector<Real> &v, 
    ...
    std::shared_ptr<std::vector<Real> > hvup = std::const_pointer_cast<std::vector<Real> >(
      (dynamic_cast<const ROL::StdVector<Real>&>(hv)).getVector());
    // Unwrap v
    std::shared_ptr<const std::vector<Real> > vup =
      (dynamic_cast<ROL::StdVector<Real> >(const_cast<ROL::Vector<Real> &&>(v))).getVector();
    // COMPUTE GRADIENT WRT U
    for(int i=0; i<ns_; i++){
      (*hvup)[i] = (*vup)[i];
...
public:
  ...
  void project( ROL::Vector<Real> &x ) {
    std::shared_ptr<std::vector<Real> > ex =
      std::const_pointer_cast<std::vector<Real> >((dynamic_cast<ROL::StdVector<Real>&>(x)).getVector());
  ...
  void pruneLowerActive(ROL::Vector<Real> &v, const ROL::Vector<Real> &x, Real eps) {
    ...
    std::shared_ptr<std::vector<Real> > ev =
      std::const_pointer_cast<std::vector<Real> >((dynamic_cast<ROL::StdVector<Real>&>(v)).getVector());
  ...
  void pruneLowerActive(ROL::Vector<Real> &v, const ROL::Vector<Real> &g, const ROL::Vector<Real> &x, Real eps) {
    ...
    std::shared_ptr<const std::vector<Real> > eg =
      (dynamic_cast<ROL::StdVector<Real> >(const_cast<ROL::Vector<Real> &&>(g))).getVector();
    std::shared_ptr<std::vector<Real> > ev =
      std::const_pointer_cast<std::vector<Real> >((dynamic_cast<ROL::StdVector<Real>&>(v)).getVector());
    Real epsn = std::min(this->scale_*eps,this->min_diff_);
    //epsn *= this->scale_;
  ...
  void setVectorToUpperBound( ROL::Vector<Real> &u ) {
    std::shared_ptr<std::vector<Real> > us = std::make_shared<std::vector<Real>>(2,0.0);
    us->assign(this->x_up_.begin(),this->x_up_.end());
    std::shared_ptr<ROL::Vector<Real> > up = std::make_shared<ROL::StdVector<Real>>(us);
    u.set(*up);
  }

  void setVectorToLowerBound( ROL::Vector<Real> &l ) {
    std::shared_ptr<std::vector<Real> > ls = std::make_shared<std::vector<Real>>(2,0.0);
    ls->assign(this->x_lo_.begin(),this->x_lo_.end());
    std::shared_ptr<ROL::Vector<Real> > lp = std::make_shared<ROL::StdVector<Real>>(ls);
    l.set(*lp);
  }
};
...
//       Vsrc_ = std::make_shared<std::vector<Real>>(n,0.0);
//       Imeas_ = std::make_shared<std::vector<Real>>(n,0.0);
...
//       Vsrc_ = std::make_shared<std::vector<Real>>(dim,0.0);
//       Imeas_ = std::make_shared<std::vector<Real>>(dim,0.0);
//       Real Vsrc, Imeas;
...
//       std::shared_ptr<std::vector<Real> > Ip =
//         std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(I)).getVector());
//       std::shared_ptr<const std::vector<Real> > Sp =
...
//         (dynamic_cast<StdVector<Real> >(const_cast<Vector<Real> &&>(S))).getVector();
//       int n = Imeas_->size();
//       StdVector<Real> I( std::make_shared<std::vector<Real>>(n,0.0) );
//       std::shared_ptr<std::vector<Real> > Ip =
//         std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(I)).getVector());
...
//       std::shared_ptr<std::vector<Real> > lambdap =
//         std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(lambda)).getVector());
      
//       std::shared_ptr<const std::vector<Real> > Ip =
...
//       std::shared_ptr<std::vector<Real> > sensp =
//         std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(sens)).getVector());
//       std::shared_ptr<const std::vector<Real> > Ip =
//         (dynamic_cast<StdVector<Real> >(const_cast<Vector<Real> &&>(I))).getVector();
//       std::shared_ptr<const std::vector<Real> > Sp =
//         (dynamic_cast<StdVector<Real> >(const_cast<Vector<Real> &&>(S))).getVector();
...
//         std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(g)).getVector());
//       std::shared_ptr<const std::vector<Real> > Sp =
//         (dynamic_cast<StdVector<Real> >(const_cast<Vector<Real> &&>(S))).getVector();
...
// 	StdVector<Real> lambda( std::make_shared<std::vector<Real>>(n,0.0) );
// 	std::shared_ptr<std::vector<Real> > lambdap =
// 	  std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(lambda)).getVector());
...
// 	StdVector<Real> sensIs( std::make_shared<std::vector<Real>>(n,0.0) );
// 	StdVector<Real> sensRs( std::make_shared<std::vector<Real>>(n,0.0) );
// 	// Solve sensitivity equations
// 	this->solve_sensitivity_Is(sensIs,I,S);
// 	this->solve_sensitivity_Rs(sensRs,I,S);
	
// 	std::shared_ptr<std::vector<Real> > sensIsp = std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(sensIs)).getVector());
// 	std::shared_ptr<std::vector<Real> > sensRsp = std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(sensRs)).getVector());
...
//       	std::shared_ptr<Vector<Real> > g = S.clone();
//       	this->gradient(*g,S,gtol);

//       	// Compute New Step S + h*v                                                                            
// 	std::shared_ptr<std::vector<Real> > Snewp = std::make_shared<std::vector<Real>>(2, 0.0);
...
// 	  std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(hv)).getVector());
// 	std::shared_ptr<const std::vector<Real> > vp =
// 	  (dynamic_cast<StdVector<Real> >(const_cast<Vector<Real> &&>(v))).getVector();
// 	std::shared_ptr<const std::vector<Real> > Sp =
// 	  (dynamic_cast<StdVector<Real> >(const_cast<Vector<Real> &&>(S))).getVector();
...
// 	StdVector<Real> w( std::make_shared<std::vector<Real>>(n,0.0) );
// 	std::shared_ptr<std::vector<Real> > wp =
// 	  std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(w)).getVector());
...
// 	StdVector<Real> p( std::make_shared<std::vector<Real>>(n,0.0) );
// 	std::shared_ptr<std::vector<Real> > pp =
// 	  std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(p)).getVector());
...
//       std::shared_ptr<std::vector<Real> > S_rcp = std::make_shared<std::vector<Real>>(2,0.0);
...
//   //     std::const_pointer_cast<std::vector<Real> >((dynamic_cast<StdVector<Real>&>(x0)).getVector());
...
//   //   obj = std::make_shared<Objective_DiodeCircuit<Real>>(0.02585,0.0,1.0,1.e-2);
